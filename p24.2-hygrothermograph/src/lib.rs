// https://rust-dd.com/post/building-a-rust-library-for-dht11-sensor-a-step-by-step-guide
#![no_std]
...
> Dht11<PIN, DELAY>
{
    ...
    pub fn read(&mut self) -> Result<SensorReading, Error> {
        ...
        Ok(SensorReading {
            ...
            humidity_decimal: humidity_decimal.unwrap() as u8,
            temperature_decimal: temperature_decimal.unwrap() as u8,
        })
    }
