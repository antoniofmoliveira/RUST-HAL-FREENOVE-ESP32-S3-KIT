...
- The pins used in the projects DONT are the same as the ones in the book that acompanies the kit because I dont have that kit. But the connectios ar the same. Only pins are altered.
