...
fn main() -> ! {
    ...
    let button12 = Input::new(peripherals.GPIO12, button_config);
    let buzzer_config = OutputConfig::default();
    let mut pin4 = Output::new(peripherals.GPIO4, Level::Low, buzzer_config);
    let delay = Delay::new();
