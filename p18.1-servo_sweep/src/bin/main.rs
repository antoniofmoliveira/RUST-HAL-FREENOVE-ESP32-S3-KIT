...
fn main() -> ! {
    ...
    loop {
        // // 0 degrees: 2.5% duty (500/20000)
        // pwm_pin.set_timestamp(500);
        // delay.delay_millis(1500);

        // // 90 degrees: 7.5% duty (1500/20000)
        // pwm_pin.set_timestamp(1500);
        // delay.delay_millis(1500);

        // // 180 degrees: 12.5% duty (2500/20000)
        // pwm_pin.set_timestamp(2500);
        // delay.delay_millis(1500);

        // for timestamp in (500..2500).step_by(20) {
        //     pwm_pin.set_timestamp(timestamp);
        //     delay.delay_millis(100);
        // }

        // for timestamp in (500..2500).step_by(20).rev() {
        //     pwm_pin.set_timestamp(timestamp);
        //     delay.delay_millis(100);
        // }

        for angle in 0..=180 {
            set_angle(&mut pwm_pin, angle);
            delay.delay_millis(100);
        }
